...
window.onload = function () {
  if (window.jQuery) {
    var progress = function progress(timeleft, timetotal, $element) {
    ...
    if ($('#progressBar').length) {
      var time = $('#progressBar').data('time');
  ...
  $("form").bind("keypress", function (e) {
    if (e.keyCode == 13) {
      $("#btnSearch").attr('value'); //add more buttons here

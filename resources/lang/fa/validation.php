...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'problem'                  => '  بیان مساله   ',
        'question'                  => '   سوال اصلی  ',
        'necessity'                  => '   ضرورت تحقیق  ',
        'innovation'                  => '  جنبه نوآوری   ',
        'ostad_id'                  => '   استاد انتخابی  ',
        'ostad'                  => '   استاد پیشنهادی  ',
        'resume'                  => '  رزومه   ',
        'masters'                  => '     اساتید',
        'user_id'                  => '    کاربر یا استاد ',
        'master_id'                  => '    استاد راهنما ',
        'curts'                  => '   طرح  ها  ',
        'users'                  => '    اساتید ',
        'question'                  => 'سوال     ',
        'a1'                  => '    جواب یک  ',
        ...
        ',
        'structure'=>'ساختار تحقیق (ترتیب فصول)
        ',
        'method'=>'روش اجرای پژوهش
        ',
        'source'=>'منابع ',
        'subjects'                  => 'موضوعات مصوب     ',
        'plans'                  => '   طرح تفصیلی  ',

        'curt_id'                  => 'طرح اجمالی     ',
        'plan_id'                  => 'طرح تفصیلی     ',
        'report'                  => '    فایل مشابهت عنوان ایرانداک ',
        'info_master'                  => ' توضیحات استاد    ',
        'confirm_master'                  => '   وضعیت طرح   ',
        'no_verifyed'                  => '   بررسی نشده   ',

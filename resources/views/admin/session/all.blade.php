            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--begin::دکمه-->
                        <a href="{{route('session.create')}}" class="btn btn-primary font-weight-bolder">
                        ...
                        <table class="datatable-table" style="display: block;">
                            ...
                            <tbody class="datatable-body" style="">
                                ...
                                <tr class="datatable-row" style="left: 0px;">
                                    ...
                                    <td class="datatable-cell text-center"><span>{{$session->name}} </span></td>
                                    ...
                                    <td class="datatable-cell text-center">
                                        <span>{{Morilog\Jalali\Jalalian::forge($session->created_at)->format('Y-m-d')}}
                                        </span>
                                    </td>
                                    {{-- <td class="datatable-cell text-center">
                                        <a class="btn btn-outline-primary"
                                            href="{{route('session.edit',$session->id)}}">ویرایش</a>
                                    </td> --}}
                                </tr>
                            ...
                            {{ $sessions->appends(Request::all())->links('sections.pagination') }}

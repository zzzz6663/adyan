            ...
            <div class="card card-custom">
                <div class="card-body p-0">
                    ...
                    <div class="wizard wizard-1" id="kt_wizard_v1" data-wizard-state="step-first"
                        ...
                        <form class="form" action="{{route('quiz.store')}}" id="kt_form"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group fv-plugins-icon-container">
                                                ...
                                                <select name="active" class="form-control" id="">
                                                    ...
                                                    <option {{old('active')=='1'?'selected':''}} value="1">  {{ __('sentences.show') }} </option>
                                                    <option {{old('active')=='0'?'selected':''}} value="0">  {{ __('sentences.hide') }}  </option>
                                                </select>
                                                <span class="form-text text-muted">

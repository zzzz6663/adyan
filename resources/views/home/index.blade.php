                                    ...
                                    <div class="login-form login-signin">
                                        ...
                                        <form class="form fv-plugins-bootstrap fv-plugins-framework" novalidate="novalidate" id="kt_login_signin_form">
                                            ...
                                            <div class="pb-13 pt-lg-0 pt-5">
                                                <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">به مترونیک خوش آمدید</h3>
                                                <span class="text-muted font-weight-bold font-size-h4">می خواهید عضو شوید؟<a href="javascript:;" id="kt_login_signup" class="text-primary font-weight-bolder">ایجاد یک حساب کاربری</a></span>
                                            </div>
                                            <!--begin::Title-->
                                            ...
                                            <div class="pb-lg-0 pb-5">
                                                <button type="button" id="kt_login_signin_submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">ورود</button>
    ...
    <path d="M10.1993 3.85336C12.1142 3.85336 13.406 4.66168 14.1425 5.33717L17.0207 2.59107C15.253 0.985496 12.9527 0 10.1993 0C6.2106 0 2.76588 2.23672 1.08887 5.49214L4.38626 7.99466C5.21352 5.59183 7.50242 3.85336 10.1993 3.85336Z" fill="#EB4335"></path>
                                    ...
                                    <div class="login-form login-signup">
                                        ...
                                        <form class="form fv-plugins-bootstrap fv-plugins-framework" novalidate="novalidate" id="kt_login_signup_form">
                                            ...
                                            <!--begin::Form group-->
                                            <div class="form-group fv-plugins-icon-container">
                                                <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="text" placeholder="نام و ناو خانوادگی" name="fullname" autocomplete="off">
                                                <div class="fv-plugins-message-container"></div></div>
                                            <!--end::Form group-->
                                            ...
                                            <div class="form-group d-flex flex-wrap pb-lg-0 pb-3">
                                                <button type="button" id="kt_login_signup_submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-4">ارسال</button>
                                                <button type="button" id="kt_login_signup_cancel" class="btn btn-light-primary font-weight-bolder font-size-h6 px-8 py-4 my-3">لغو</button>
                                            </div>
                                            <!--end::Form group-->
                                            <div></div></form>
                                        <!--end::Form-->
                                    ...
                                    <div class="login-form login-forgot">
                                        ...
                                        <form class="form fv-plugins-bootstrap fv-plugins-framework" novalidate="novalidate" id="kt_login_forgot_form">
                                            ...
                                            <div class="pb-13 pt-lg-0 pt-5">
                                                ...
                                                <p class="text-muted font-weight-bold font-size-h4">ایمیل تان را وارد کنید تا پسوردتان ریست شود</p>
                                            </div>
                                            <!--end::Title-->

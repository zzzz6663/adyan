                                    ...
                                    <div class="login-form login-signin">
                                        ...
                                        <form method="POST" autocomplete="off" action="{{route('user.signin')}}">
                                            ...
                                            <div class="pb-13 pt-lg-0 pt-5">
                                                ...
                                                <span class="text-muted font-weight-bold font-size-h4">می خواهید عضو شوید؟<a href="{{route('user.register1')}}"  class="text-primary font-weight-bolder">ایجاد یک حساب کاربری</a></span>
                                            </div>
                                            <!--begin::Title-->

    ...
    <div class="wizard-nav border-bottom">
        <div class="wizard-steps p-8 p-lg-10">
            ...
            <div class="wizard-step" data-wizard-type="step" data-wizard-state="{{$step>=2?'current':'pending'}}">
                <div class="wizard-label">
                    <span class="svg-icon svg-icon-4x wizard-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/ارتباطات/چت-check.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <div class="wizard-step" data-wizard-type="step" data-wizard-state="{{$step>=3?'current':'pending'}}">
                <div class="wizard-label">
                    <span class="svg-icon svg-icon-4x wizard-icon">
            ...
            <div class="wizard-step" data-wizard-type="step" data-wizard-state="{{$step>=4?'current':'pending'}}">
                <div class="wizard-label">
                    <span class="svg-icon svg-icon-4x wizard-icon">
            ...
            <div class="wizard-step" data-wizard-type="step" data-wizard-state="{{$step>=5?'current':'pending'}}">
                <div class="wizard-label">
                    <span class="svg-icon svg-icon-4x wizard-icon">
